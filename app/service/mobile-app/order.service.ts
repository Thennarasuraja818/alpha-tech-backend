import { OrderDomainRepository, OrderDomainService } from "../../../domain/mobile-app/orderDomain";
...
class OrderService implements OrderDomainService {
    constructor(private repo: OrderDomainRepository) { }
...
export function OrderServiceFun(
    repo: OrderDomainRepository
): OrderDomainService {
